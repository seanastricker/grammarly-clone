 ...
 * @version 1.0.0
 * 
 * Login page component with functional authentication form.
 ...
 * 
 * User authentication page with login form and OAuth options.
 * 
 * @component
 */
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center space-x-2 cursor-pointer">
                <input
                  ...
                  disabled={isLoading}
                />
                <span className="text-body-small text-muted-foreground">Remember me</span>
              </label>
              <Link
                to="/forgot-password"
